...
#endif
#ifdef ENABLE_SPECIAL_STORAGE
	{	"transfer_inv_storage",			do_transfer_inv_storage,		0,						POS_DEAD,			GM_PLAYER	},
	{	"transfer_storage_inv",			do_transfer_storage_inv,		0,						POS_DEAD,			GM_PLAYER	},
#endif //eypcn
#ifdef ENABLE_10_STATU
	{ "stat_val",			do_stat_val,				0,			POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_SORT_INVENTORY
	{ "click_sort_inventory",		do_sort_inventory_items,	0,			POS_DEAD,	GM_PLAYER },
	{ "click_sort_special_storage", do_sort_special_storage,	0,			POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_PVP_RANKING
	{ "pvp_ranking",	do_pvp_ranking,		0,		POS_DEAD,	GM_IMPLEMENTOR },
#endif
#ifdef ENABLE_WHEEL_OF_FORTUNE
	{ "whell",	do_wheel_of_fortune,		0,		POS_DEAD,	GM_PLAYER },
#endif
