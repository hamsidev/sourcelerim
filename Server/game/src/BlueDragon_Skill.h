...
#ifdef on
					int64_t addPct = BlueDragon_GetRangeFactor("hp_damage", pAttacker->GetHPPct());
#else
...
#ifdef on
					int64_t dam = number(BlueDragon_GetSkillFactor(3, "Skill0", "default_damage", "min"), BlueDragon_GetSkillFactor(3, "Skill0", "default_damage", "max"));
#else
...
#ifdef on
					int64_t dam = number( BlueDragon_GetSkillFactor(3, "Skill1", "default_damage", "min"), BlueDragon_GetSkillFactor(3, "Skill1", "default_damage", "max") );
#else
...
#ifdef on
					int64_t dam = number( BlueDragon_GetSkillFactor(3, "Skill2", "default_damage", "min"), BlueDragon_GetSkillFactor(3, "Skill2", "default_damage", "max") );
#else
