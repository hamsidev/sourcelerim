...
const TItemData * CPythonPlayer::GetItemData(TItemPos Cell) const
{
	...
	case DRAGON_SOUL_INVENTORY:
		...
		case GENERAL_INVENTORY:
			return &m_playerStatus.aSSGItem[Cell.cell];
		case BONUS_INVENTORY:
			return &m_playerStatus.aSSBOItem[Cell.cell];
#endif
...
void CPythonPlayer::SetItemData(TItemPos Cell, const TItemData & c_rkItemInst)
{
	...
	case DRAGON_SOUL_INVENTORY:
		...
		case STONE_INVENTORY:
			...
			break;
		case GENERAL_INVENTORY:
			m_playerStatus.aSSGItem[Cell.cell] = c_rkItemInst;
			break;
		case BONUS_INVENTORY:
			m_playerStatus.aSSBOItem[Cell.cell] = c_rkItemInst;
			break;
#endif
