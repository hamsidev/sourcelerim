...
#ifdef SANDIK_AC
	HEADER_CG_INSTANT_OPEN						 = 120,
#endif
#ifdef ENABLE_TARGET_INFORMATION_SYSTEM
	HEADER_CG_TARGET_INFO_LOAD					 = 121,
#endif
#ifdef ENABLE_CUBE_RENEWAL_WORLDARD
	HEADER_CG_CUBE_RENEWAL						 = 122,
#endif
#ifdef ENABLE_FT_GAME_SYSTEM
	HEADER_CG_ITEM_USE_NEW_ATTRIBUTE			 = 123,
#endif
#ifdef ENABLE_SHOW_CHEST_DROP_SYSTEM
	HEADER_CG_CHEST_DROP_INFO					 = 124,
#endif
#ifdef ITEM_SHOP
	HEADER_CG_ITEMSHOP_PROCESS						= 125,
#endif
...
#endif
#ifdef ENABLE_TARGET_INFORMATION_SYSTEM
	HEADER_GC_TARGET_INFO						 = 162,
#endif
#ifdef ENABLE_CUBE_RENEWAL_WORLDARD
	HEADER_GC_CUBE_RENEWAL						 = 163,
#endif
#ifdef ENABLE_SHOW_CHEST_DROP_SYSTEM
	HEADER_GC_CHEST_DROP_INFO					 = 164,
#endif
#ifdef ENABLE_PVP_RANKING
	HEADER_GC_PVP_RANKING						= 165,
#endif
#ifdef ITEM_SHOP
	HEADER_GC_ITEMSHOP_CATEGORY						= 166,
	HEADER_GC_ITEMSHOP_ITEM							= 167,
#endif
#ifdef ENABLE_RONARK_SYSTEM
	HEADER_GC_RONARK = 168,
#endif
...
#ifdef ENABLE_ITEM_COUNT_LIMIT_SYSTEM
	DWORD		bCount;	// count of TShopItemTable, max 1000
#else
...
#ifdef ENABLE_RONARK_SYSTEM
typedef struct SPacketGCRonark
{
	BYTE	header;
	DWORD	dwGuildID;
	DWORD	dwDamage;
...
enum
{
	ITEMSHOP_PROCESS_NONE,
	ITEMSHOP_PROCESS_REFRESH,
	ITEMSHOP_PROCESS_BUY,
};
typedef struct packet_ishop_size
{
	BYTE	bHeader;
	WORD	dataSize;
} TCGItemShopSize;
typedef struct SGCIShopCategory
{
	WORD	catID;
	char	categoryName[SHOP_CHAR_MAX_NUM];
	BYTE	mainID;
} TGCIShopCategory;
typedef struct SGCIShopItem
{
	DWORD	iID;
	DWORD	iVnum;
	DWORD	iPrice;
...
typedef struct SCGProcess
{
	BYTE	bHeader;
	BYTE	bSubHeader;
	DWORD	itemID;
	BYTE	itemCount;
	char	szCategoryStr[SHOP_CAT_MAX_NUM];
	bool	withQuery;
} TCGItemShopProcess;
#endif
