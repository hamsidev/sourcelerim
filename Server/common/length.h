...
enum EMisc
{
	...
	SPECIAL_INVENTORY_PAGE_COLUMN	= 5, // 5 (default)
	SPECIAL_INVENTORY_PAGE_ROW		= 9, // 9 (default)
	SPECIAL_INVENTORY_PAGE_SIZE		= SPECIAL_INVENTORY_PAGE_COLUMN*SPECIAL_INVENTORY_PAGE_ROW,
	SPECIAL_INVENTORY_PAGE_COUNT	= 4,
	SPECIAL_INVENTORY_MAX_NUM 		= SPECIAL_INVENTORY_PAGE_SIZE*SPECIAL_INVENTORY_PAGE_COUNT, // 90 (default)
#endif
...
#ifdef ENABLE_SPECIAL_STORAGE
	bool IsDefaultSpecialStoragePosition() const
	{
		return ((UPGRADE_INVENTORY == window_type || BOOK_INVENTORY == window_type || STONE_INVENTORY == window_type || GENERAL_INVENTORY == window_type || BONUS_INVENTORY == window_type) && cell < SPECIAL_INVENTORY_MAX_NUM);
	}
#endif
