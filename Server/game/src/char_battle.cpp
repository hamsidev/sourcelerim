...
void CHARACTER::ItemDropPenalty(LPCHARACTER pkKiller)
{
	...
	if (GetRealAlignment() >= 30000000)
		iAlignIndex = 0;
	else if (GetRealAlignment() >= 29000000)
		iAlignIndex = 1;
	else if (GetRealAlignment() >= 28000000)
		iAlignIndex = 2;
	else if (GetRealAlignment() >= 27000000)
		iAlignIndex = 3;
	else if (GetRealAlignment() >= 26000000)
		iAlignIndex = 4;
	else if (GetRealAlignment() >= 25000000)
		iAlignIndex = 5;
	else if (GetRealAlignment() >= 24000000)
		iAlignIndex = 6;
	else if (GetRealAlignment() >= 23000000)
		iAlignIndex = 7;
	else if (GetRealAlignment() >= 22000000)
		iAlignIndex = 8;
	else if (GetRealAlignment() >= 21000000)
		iAlignIndex = 9;
	else if (GetRealAlignment() >= 20000000)
		iAlignIndex = 10;
	else if (GetRealAlignment() >= 19000000)
		iAlignIndex = 11;
	else if (GetRealAlignment() >= 18000000)
		iAlignIndex = 12;
	else if (GetRealAlignment() >= 17000000)
		iAlignIndex = 13;
	else if (GetRealAlignment() >= 16000000)
		iAlignIndex = 14;
	else if (GetRealAlignment() >= 15000000)
		iAlignIndex = 15;
	else if (GetRealAlignment() >= 14000000)
		iAlignIndex = 16;
	else if (GetRealAlignment() >= 13000000)
		iAlignIndex = 17;
	else if (GetRealAlignment() >= 12000000)
		iAlignIndex = 18;
	else if (GetRealAlignment() >= 11000000)
		iAlignIndex = 19;
		...
		iAlignIndex = 22;
	else if (GetRealAlignment() >= 7000000)
		iAlignIndex = 23;
	else if (GetRealAlignment() >= 6000000)
		iAlignIndex = 24;
	else if (GetRealAlignment() >= 5000000)
		iAlignIndex = 25;
	else if (GetRealAlignment() >= 4000000)
		iAlignIndex = 26;
	else if (GetRealAlignment() >= 3000000)
		iAlignIndex = 27;
		...
		iAlignIndex = 35;
	else if (GetRealAlignment() >= 320000)
		iAlignIndex = 36;
	else if (GetRealAlignment() >= 240000)
		iAlignIndex = 37;
...
#ifdef ENABLE_RONARK_SYSTEM
	if (GetRaceNum() == RONARK_BOSS)
	{
		if (pkKiller && pkKiller->IsPC())
		{
			if (pkKiller->GetGuild())
			{
				if (CRonarkMapManager::instance().IsRonarkMap(pkKiller->GetMapIndex()) && CRonarkMapManager::instance().IsRonarkActivate())
				{
					CRonarkMapManager::instance().Reward();
				}
			}
		}
	}
...
#ifdef ENABLE_PVP_RANKING
					&& (pkKiller->GetPKMode() != PK_MODE_BATTLE)
#endif
				)
				{
...
#endif
{
	...
	if (!cannot_dead)
	{
		...
		if (GetRaceNum() == RONARK_BOSS)
		{
			if (pAttacker && pAttacker->IsPC())
			{
				if (pAttacker->GetGuild())
				{
					if (CRonarkMapManager::instance().IsRonarkMap(pAttacker->GetMapIndex()) && CRonarkMapManager::instance().IsRonarkActivate())
					{
						CRonarkMapManager::instance().OnDamage(pAttacker->GetGuild(), dam);
					}
				}
			}
		}
...
#ifdef on
		const int64_t iDam	= it->second.iTotalDamage;
#else
...
LPCHARACTER CHARACTER::DistributeExp()
{
	...
	while (it != m_map_kDamage.end())
	{
		const VID & c_VID = it->first;
#ifdef on
		int64_t iDam = it->second.iTotalDamage;
#else
...
#ifdef ENABLE_ALIGN_RENEWAL
int CHARACTER::GetAlignIndex(int m_iRealAlignment)
{
	BYTE iAlignIndex;

	if (m_iRealAlignment >= 30000000)
		iAlignIndex = 0;
	else if (m_iRealAlignment >= 29000000)
		iAlignIndex = 1;
	else if (m_iRealAlignment >= 28000000)
		iAlignIndex = 2;
	else if (m_iRealAlignment >= 27000000)
		iAlignIndex = 3;
	else if (m_iRealAlignment >= 26000000)
		iAlignIndex = 4;
	else if (m_iRealAlignment >= 25000000)
		iAlignIndex = 5;
	else if (m_iRealAlignment >= 24000000)
		iAlignIndex = 6;
	else if (m_iRealAlignment >= 23000000)
		iAlignIndex = 7;
	else if (m_iRealAlignment >= 22000000)
		iAlignIndex = 8;
	else if (m_iRealAlignment >= 21000000)
		iAlignIndex = 9;
	else if (m_iRealAlignment >= 20000000)
		iAlignIndex = 10;
	else if (m_iRealAlignment >= 19000000)
		iAlignIndex = 11;
	else if (m_iRealAlignment >= 18000000)
		iAlignIndex = 12;
	else if (m_iRealAlignment >= 17000000)
		iAlignIndex = 13;
	else if (m_iRealAlignment >= 16000000)
		iAlignIndex = 14;
	else if (m_iRealAlignment >= 15000000)
		iAlignIndex = 15;
	else if (m_iRealAlignment >= 14000000)
		iAlignIndex = 16;
	else if (m_iRealAlignment >= 13000000)
		iAlignIndex = 17;
	else if (m_iRealAlignment >= 12000000)
		iAlignIndex = 18;
	else if (m_iRealAlignment >= 11000000)
		iAlignIndex = 19;
	else if (m_iRealAlignment >= 10000000)
		iAlignIndex = 20;
	else if (m_iRealAlignment >= 9000000)
		iAlignIndex = 21;
	else if (m_iRealAlignment >= 8000000)
		iAlignIndex = 22;
	else if (m_iRealAlignment >= 7000000)
		iAlignIndex = 23;
	else if (m_iRealAlignment >= 6000000)
		iAlignIndex = 24;
	else if (m_iRealAlignment >= 5000000)
		iAlignIndex = 25;
	else if (m_iRealAlignment >= 4000000)
		iAlignIndex = 26;
	else if (m_iRealAlignment >= 3000000)
		iAlignIndex = 27;
	else if (m_iRealAlignment >= 2000000)
		iAlignIndex = 28;
	else if (m_iRealAlignment >= 1000000)
		iAlignIndex = 29;
	else if (m_iRealAlignment >= 900000)
		iAlignIndex = 30;
	else if (m_iRealAlignment >= 800000)
		iAlignIndex = 31;
	else if (m_iRealAlignment >= 700000)
		iAlignIndex = 32;
	else if (m_iRealAlignment >= 600000)
		iAlignIndex = 33;
	else if (m_iRealAlignment >= 500000)
		iAlignIndex = 34;
	else if (m_iRealAlignment >= 400000)
		iAlignIndex = 35;
	else if (m_iRealAlignment >= 320000)
		iAlignIndex = 36;
	else if (m_iRealAlignment >= 240000)
		iAlignIndex = 37;
	else if (m_iRealAlignment >= 160000)
		iAlignIndex = 38;
	else if (m_iRealAlignment >= 80000)
		iAlignIndex = 39;
	else if (m_iRealAlignment >= 10000)
		iAlignIndex = 40;
	else
		iAlignIndex = 41;
...
#ifdef ENABLE_ALIGN_RENEWAL
	int old_align_index = GetAlignIndex(m_iRealAlignment);

	m_iRealAlignment = MINMAX(-200000, m_iRealAlignment + iAmount, 30000000);

	int now_align_index = GetAlignIndex(m_iRealAlignment);
	if (old_align_index != now_align_index)
		OnAlignUpdate(now_align_index);
...
struct FuncAggregateMonster
{
	...
	void operator()(LPENTITY ent)
	{
		if (ent->IsType(ENTITY_CHARACTER))
		{
			...
			if (DISTANCE_APPROX(ch->GetX() - m_ch->GetX(), ch->GetY() - m_ch->GetY()) < 10000)//@hinata22
				if (ch->CanBeginFight())
					ch->BeginFight(m_ch);
		}
	}
...
#endif
{
	...
	if (type != DAMAGE_TYPE_POISON)//@hinata37
...
#ifdef on
void CHARACTER::ChangeVictimByAggro(int64_t iNewAggro, LPCHARACTER pNewVictim)
#else
