...
#ifdef ENABLE_FIX //19.12.2022 - Eklendi
	if (pkItem == nullptr)
	{
		sys_err("item_destroy_event> <pkItem> Null pointer");
		return 0;
	}
#endif
	if (pkItem->GetOwner())
...
LPITEM CItem::RemoveFromCharacter()
{
	...
	else
	{
		if (GetWindow() != SAFEBOX && GetWindow() != MALL)
		{
			...
			else if (IsSpecialStorageItem() && m_bWindow == GetSpecialWindowType())
			{
				if (m_wCell >= SPECIAL_INVENTORY_MAX_NUM)
					sys_err("CItem::RemoveFromCharacter: pos >= SPECIAL_INVENTORY_MAX_NUM IsSpecialStorageItem");
				else
					pOwner->SetItem(TItemPos(m_bWindow, m_wCell), NULL);
			}
#endif
...
#ifdef ENABLE_SPECIAL_STORAGE
	else if (GetSpecialWindowType() == window_type)
	{
		if (m_wCell >= SPECIAL_INVENTORY_MAX_NUM)
		{
			sys_err("CItem::AddToCharacter:storage cell overflow: %s to %s cell %d", m_pProto->szName, ch->GetName(), m_wCell);
			return false;
		}
	}
#endif
...
int CItem::FindEquipCell(LPCHARACTER ch, int iCandidateCell)
{
	if ((0 == GetWearFlag() || ITEM_TOTEM == GetType()) && ITEM_COSTUME != GetType() && ITEM_DS != GetType() && ITEM_SPECIAL_DS != GetType() && ITEM_RING != GetType() && ITEM_BELT != GetType()
		...
		#endif
#ifdef SOCKET_SLOTS
	&& ITEM_SOCKET1 != GetType()
	&& ITEM_SOCKET2 != GetType()
	&& ITEM_SOCKET3 != GetType()
	&& ITEM_SOCKET4 != GetType()
	&& ITEM_SOCKET5 != GetType()
	&& ITEM_SOCKET6 != GetType()
	&& ITEM_SOCKET7 != GetType()
	&& ITEM_SOCKET8 != GetType()
	&& ITEM_SOCKET9 != GetType()
	&& ITEM_SOCKET10 != GetType()
	&& ITEM_SOCKET11 != GetType()
	&& ITEM_SOCKET12 != GetType()
	&& ITEM_SOCKET13 != GetType()
	&& ITEM_SOCKET14 != GetType()
	&& ITEM_SOCKET15 != GetType()
	&& ITEM_SOCKET16 != GetType()
	&& ITEM_SOCKET17 != GetType()
	&& ITEM_SOCKET18 != GetType()
	&& ITEM_SOCKET19 != GetType()
	&& ITEM_SOCKET20 != GetType()
	&& ITEM_SOCKET21 != GetType()
	&& ITEM_SOCKET22 != GetType()
	&& ITEM_SOCKET23 != GetType()
	&& ITEM_SOCKET24 != GetType()
	&& ITEM_SOCKET25 != GetType()
#endif
	)
		return -1;
	...
	#endif
#ifdef SOCKET_SLOTS
	else if (GetType() == ITEM_SOCKET1)
		return WEAR_SOCKET1;
	else if (GetType() == ITEM_SOCKET2)
		return WEAR_SOCKET2;
	else if (GetType() == ITEM_SOCKET3)
		return WEAR_SOCKET3;
	else if (GetType() == ITEM_SOCKET4)
		return WEAR_SOCKET4;
	else if (GetType() == ITEM_SOCKET5)
		return WEAR_SOCKET5;
	else if (GetType() == ITEM_SOCKET6)
		return WEAR_SOCKET6;
	else if (GetType() == ITEM_SOCKET7)
		return WEAR_SOCKET7;
	else if (GetType() == ITEM_SOCKET8)
		return WEAR_SOCKET8;
	else if (GetType() == ITEM_SOCKET9)
		return WEAR_SOCKET9;
	else if (GetType() == ITEM_SOCKET10)
		return WEAR_SOCKET10;
	else if (GetType() == ITEM_SOCKET11)
		return WEAR_SOCKET11;
	else if (GetType() == ITEM_SOCKET12)
		return WEAR_SOCKET12;
	else if (GetType() == ITEM_SOCKET13)
		return WEAR_SOCKET13;
	else if (GetType() == ITEM_SOCKET14)
		return WEAR_SOCKET14;
	else if (GetType() == ITEM_SOCKET15)
		return WEAR_SOCKET15;
	else if (GetType() == ITEM_SOCKET16)
		return WEAR_SOCKET16;
	else if (GetType() == ITEM_SOCKET17)
		return WEAR_SOCKET17;
	else if (GetType() == ITEM_SOCKET18)
		return WEAR_SOCKET18;
	else if (GetType() == ITEM_SOCKET19)
		return WEAR_SOCKET19;
	else if (GetType() == ITEM_SOCKET20)
		return WEAR_SOCKET20;
	else if (GetType() == ITEM_SOCKET21)
		return WEAR_SOCKET21;
	else if (GetType() == ITEM_SOCKET22)
		return WEAR_SOCKET22;
	else if (GetType() == ITEM_SOCKET23)
		return WEAR_SOCKET23;
	else if (GetType() == ITEM_SOCKET24)
		return WEAR_SOCKET24;
	else if (GetType() == ITEM_SOCKET25)
		return WEAR_SOCKET25;
#endif
...
EVENTFUNC(ownership_event)
{
	...
	if (pkItem == nullptr)
	{
		sys_err("ownership_event> <pkItem> Null pointer");
		return 0;
	}
#endif
...
EVENTFUNC(unique_expire_event)
{
	...
	if (pkItem == nullptr)
	{
		sys_err("unique_expire_event> <pkItem> Null pointer");
		return 0;
	}
#endif
...
EVENTFUNC(timer_based_on_wear_expire_event)
{
	...
	if (pkItem == nullptr)
	{
		sys_err("expire_event> <pkItem> Null pointer");
		return 0;
	}
#endif
...
EVENTFUNC(accessory_socket_expire_event)
{
	...
	if (item == nullptr)
	{
		sys_err("accessory_socket_expire_event> <item> Null pointer");
		return 0;
	}
#endif
...
{
	return (GetType() == ITEM_MATERIAL && GetSubType() == MATERIAL_LEATHER || GetType() == ITEM_RESOURCE);
}
bool CItem::IsBook()
{
	return (GetType() == ITEM_SKILLBOOK || GetType() == ITEM_SKILLFORGET || GetVnum() >= 50401 && GetVnum() <= 50510 || GetVnum() >= 50530 && GetVnum() <= 50535 || GetVnum() == 50300 || GetVnum() == 50060);
}
bool CItem::IsStone()
{
...
{
	return (IS_SET(GetFlag(), ITEM_FLAG_GENERAL) || GetType() == ITEM_GIFTBOX);
}
bool CItem::IsBonus()
{
	return ((GetType() == ITEM_USE && (GetSubType() == USE_CHANGE_ATTRIBUTE || GetSubType() == USE_CHANGE_ATTRIBUTE2 || GetSubType() == USE_ADD_ATTRIBUTE || GetSubType() == USE_ADD_ATTRIBUTE2)));
}
