...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		...
		Set(HEADER_GC_RONARK, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCRonark), STATIC_SIZE_PACKET));
#endif
		...
		Set(HEADER_GC_CHEST_DROP_INFO, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCChestDropInfo), true));
			...
			Set (HEADER_GC_PVP_RANKING, CNetworkPacketHeaderMap::TPacketType (sizeof (TPacketGCPvPRanking), STATIC_SIZE_PACKET));
#endif


#ifdef ITEM_SHOP
		Set(HEADER_GC_ITEMSHOP_CATEGORY, CNetworkPacketHeaderMap::TPacketType (sizeof (TGCIShopCategory), DYNAMIC_SIZE_PACKET));
		Set(HEADER_GC_ITEMSHOP_ITEM, CNetworkPacketHeaderMap::TPacketType (sizeof (TGCIShopItem), DYNAMIC_SIZE_PACKET));
#endif
...
//			return rkSimplePlayerInfo.wParts[CRaceData::PART_MAIN];
		...
		case ACCOUNT_CHARACTER_SLOT_WING:
			return rkSimplePlayerInfo.wWingPart;
			break;
#endif
