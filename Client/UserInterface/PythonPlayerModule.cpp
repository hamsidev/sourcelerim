...
void initPlayer()
{
	...
	PyModule_AddIntConstant(poModule, "SLOT_TYPE_GENERAL_INVENTORY",		SLOT_TYPE_GENERAL_INVENTORY);
	PyModule_AddIntConstant(poModule, "SLOT_TYPE_BONUS_INVENTORY",			SLOT_TYPE_BONUS_INVENTORY);
	...
	PyModule_AddIntConstant(poModule, "GENERAL_INVENTORY",					GENERAL_INVENTORY);
	PyModule_AddIntConstant(poModule, "BONUS_INVENTORY",					BONUS_INVENTORY);
