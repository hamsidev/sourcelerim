...
#ifdef ENABLE_WINGS_NEW
PyObject* chrSetWing(PyObject* poSelf, PyObject* poArgs)
{
	int iWing;
	if (!PyTuple_GetInteger(poArgs, 0, &iWing))
		return Py_BuildException();
...
void initchr()
{
...
#ifdef ENABLE_WINGS_NEW
		{ "SetWing",						chrSetWing,							METH_VARARGS },
#endif
		{ NULL,								NULL,								NULL		 },
	};
	...
	PyModule_AddIntConstant(poModule, "AFFECT_RONARK_GUILD", CInstanceBase::AFFECT_RONARK_GUILD);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_RONARK_GUILD", CInstanceBase::NEW_AFFECT_RONARK_GUILD);
#endif
