...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_MESSENGER_REMOVE_FIX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MESSENGER_REMOVE_FIX", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PET_SLOT",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PET_SLOT",	0);
#endif
...
#ifdef ITEM_SHOP
	PyModule_AddIntConstant (poModule, "ITEM_SHOP", 1);
#else
	PyModule_AddIntConstant (poModule, "ITEM_SHOP", 0);
#endif

#ifdef ENABLE_WHEEL_OF_FORTUNE
	PyModule_AddIntConstant(poModule, "ENABLE_WHEEL_OF_FORTUNE",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WHEEL_OF_FORTUNE",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_RONARK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RONARK_SYSTEM", 0);
#endif
#ifdef ENABLE_FT_GAME_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_FT_GAME_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FT_GAME_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant (poModule, "ENABLE_PVP_RANKING", 1);
	PyModule_AddIntConstant (poModule, "ENABLE_PVP_RANKING_WITH_EMPIRE", 1);
#else
	PyModule_AddIntConstant (poModule, "ENABLE_PVP_RANKING", 0);
	PyModule_AddIntConstant (poModule, "ENABLE_PVP_RANKING_WITH_EMPIRE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_WINGS_NEW", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WINGS_NEW", 0);
#endif

#ifdef NEW_PVM_ATTRIBUTE
	PyModule_AddIntConstant(poModule, "NEW_PVM_ATTRIBUTE", 1);
#else
	PyModule_AddIntConstant(poModule, "NEW_PVM_ATTRIBUTE", 0);
#endif
