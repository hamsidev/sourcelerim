...
#endif
#ifdef ITEM_SHOP
		bool SendItemShopPacket (BYTE subHeader, BYTE itemCount, DWORD itemID, char* szCategoryStr, bool withQueryStr);
#endif
		// Client Version
...
#ifdef ITEM_SHOP
		bool RecvItemShopCategoryPacket();
		bool RecvItemShopItemsPacket();
#endif
		// Mount
