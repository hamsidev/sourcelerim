...
class CInstanceBase
{
...
#ifdef ENABLE_ALIGN_RENEWAL
			NEW_AFFECT_ALIGN_BONUS1 = 900,
			NEW_AFFECT_ALIGN_BONUS2 = 901,
			NEW_AFFECT_ALIGN_BONUS3 = 902,
#endif
	...
	public:
		...
		bool					SetWeapon(DWORD eWeapon, bool bRenderTarget = false);
#else
		bool					SetWeapon(DWORD eWeapon);
#endif
		bool					ChangeArmor(DWORD dwArmor);
#ifdef ENABLE_MODEL_RENDER_TARGET
		void					ChangeWeapon(DWORD eWeapon, bool bRenderTarget = false);
#else
	...
	protected:
		...
		void	__ClearAuraShiningEffect(bool detaching = true);
#endif
#ifdef ENABLE_WINGS_NEW
		void	__ClearWingShiningEffect(bool detaching = true);
		void	__AttachWingShiningEffect(int effectIndex, const char* effectFileName, const char* boneName = "Bip01");
#endif
		...
		void	__AttachAuraShiningEffect(int effectIndex, const char* effectFileName, const char* boneName = "Bip01");
#endif
	...
	protected:
		...
		DWORD					m_auraShiningEffects[CItemData::ITEM_SHINING_MAX_COUNT];
#ifdef ENABLE_WINGS_NEW
		DWORD					m_wingShiningEffects[CItemData::ITEM_SHINING_MAX_COUNT];
#endif
#endif
